...
var person = { name: 'Tyler', age: 18, infor: { address: 'HCM', phone: '123' } };
var {
	name,
	age,
	infor: { address, phone },
...
```js
const arr = [1, 'Tyler', false, 0, true, NaN, 2001];
var filteredArr = arr.filter(Boolean);

// result: filteredArr = [1, "Tyler", true, 2001]
```
